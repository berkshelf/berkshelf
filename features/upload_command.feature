Feature: upload command
  ...
  Scenario: Running the upload command with no arguments
  ...
  @chef_server
  Scenario: Running the upload command when the Berksfile defines a path location
  ...
  @chef_server
  Scenario: Running the upload command when the Berksfile defines a git location
    Given the cookbook store has the cookbooks:
  ...
  @chef_server @slow_process
  Scenario: Running the upload command for a multiple cookbooks
    Given the cookbook store has the cookbooks:
      | ntp  | 1.0.0 |
      | vim  | 1.0.0 |
      | apt  | 1.0.0 |
  ...
  @chef_server @slow_process
  Scenario: Running the upload command with the --only flag
    Given the cookbook store has the cookbooks:
      | core    | 1.0.0 |
      | system  | 1.0.0 |
    Given I write to "Berksfile" with:
  ...
  @chef_server @slow_process
  Scenario: Running the upload command with the --only flag specifying multiple groups
    Given the cookbook store has the cookbooks:
      | core    | 1.0.0 |
      | system  | 1.0.0 |
    Given I write to "Berksfile" with:
  ...
  @chef_server @slow_process
  Scenario: Running the upload command with the --except flag
    Given the cookbook store has the cookbooks:
      | core    | 1.0.0 |
      | system  | 1.0.0 |
    Given I write to "Berksfile" with:
  ...
  @chef_server @slow_process
  Scenario: Running the upload command with the --except flag specifying multiple groups
    Given the cookbook store has the cookbooks:
      | core    | 1.0.0 |
      | system  | 1.0.0 |
    Given I write to "Berksfile" with:
