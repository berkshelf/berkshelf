Feature: berks install
  ...
  Scenario: installing demands from all groups
    ...
    Then the output should contain:
      """
      Installing ruby (1.0.0) from [api: http://0.0.0.0:26210] [endpoint: http://localhost:26310/]
      Installing elixir (1.0.0) from [api: http://0.0.0.0:26210] [endpoint: http://localhost:26310/]
      """
    And the cookbook store should have the cookbooks:
      | ruby   | 1.0.0 |
      | elixir | 1.0.0 |
