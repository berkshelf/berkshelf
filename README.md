...
Berkshelf is now included as part of the [Chef Workstation](https://downloads.chef.io/products/workstation/). This is fastest, easiest, and the recommended installation method for getting up and running with Berkshelf.
