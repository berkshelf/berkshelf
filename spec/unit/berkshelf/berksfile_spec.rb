      ...
      describe "::vendor" do
        ...
        context "with a chefignore" do
          before(:each) do
            ...
            Berkshelf::Chef::Chefignore.any_instance.stub(:remove_ignores_from).and_return(['metadata.rb'])
          end

          it "finds a chefignore file" do
            Berkshelf::Chef::Chefignore.should_receive(:new).with(File.expand_path('chefignore'))
