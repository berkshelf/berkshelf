  ...
  describe Shell do
    ...
    describe '#mute!' do
      it 'sets @mute to true' do
        subject.mute!
        expect(subject.instance_variable_get(:@mute)).to be_truthy
      end
    end
    ...
    describe '#unmute!' do
      it 'sets @mute to false' do
        subject.unmute!
        expect(subject.instance_variable_get(:@mute)).to be_falsey
      end
    end
    ...
    describe '#say' do
      ...
      context 'with not quiet?' do
        ...
        it 'prints to stdout' do
          ...
          expect(stdout).to receive(:flush).with(no_args())
          subject.say 'message'
        end
      end
    end
    ...
    context '#error' do
      ...
      context 'with not quiet?' do
        ...
        it 'prints to stderr' do
          expect(stderr).to receive(:puts).with(windows? ? "error!" : "\e[31merror!\e[0m")
          subject.error 'error!'
        end
      end
    end
