...
describe Berkshelf::PathLocation do
  ...
  describe '#to_s' do
    ...
    it 'includes the path' do
      expect(subject.to_s).to eq("#<#{described_class} #{subject.path}>")
    end
  end
  ...
  describe '#inspect' do
    ...
    it 'includes the path' do
      expect(subject.inspect).to eq("#<#{described_class} #{subject.path}, name: #{subject.name}, version_constraint: #{subject.version_constraint}>")
    end
  end
