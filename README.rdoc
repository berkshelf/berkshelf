...
[git]
    cookbook "mysql", git: "https://github.com/opscode-cookbooks/mysql.git", ref: "<any git ref>" # ref can be a branch name, tag, or commit hash

[path]
    cookbook "my_application", path: "/path/to/location/of" # knife cookbook dependencies will look in /path/to/location/of/my_application for the cookbook
