...
## <a name="the-berkshelf"></a> The Berkshelf
...
## <a name="configuring-berkshelf"></a> Configuring Berkshelf
...
## <a name="vagrant-with-berkshelf"></a> Vagrant with Berkshelf
...
## <a name="the-berksfile"></a> The Berksfile
...
## <a name="generating-a-new-cookbook"></a> Generating a New Cookbook
...
## <a name="build-integration"></a> Build Integration
